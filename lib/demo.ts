...
export const DEMO_OBJECTS: BookmarkObject[] = [
  ...
  make('site-notion','room-home','Notes & ideas','https://www.notion.so/','book','#a995d0',[4.85,1.27,-3.15],true,-Math.PI/2,{kind:'shelf',surfaceId:'den-shelf'}),
  ...
  make('site-docs','room-dev','MDN Web Docs','https://developer.mozilla.org/','book','#6eb8ad',[-7.2,1.27,3.35],true,Math.PI/2,{kind:'shelf',surfaceId:'studio-shelf'}),
  ...
  make('site-youtube','room-media','YouTube','https://www.youtube.com/','tv','#c85c69',[4.35,.78,-6.05],true,0,{kind:'media',surfaceId:'lounge-media'}),
