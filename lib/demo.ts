...
export const DEMO_OBJECTS: BookmarkObject[] = [
  make('site-search','room-home','Google Search','https://www.google.com/','pedestal','#70cad8',[-2.5,0,-2.2],true,0,{kind:'floor',surfaceId:'den-search'}),
  ...
  make('site-stackoverflow','room-dev','Stack Overflow','https://stackoverflow.com/','book','#f48024',[-3.8,1.27,6.7],true,Math.PI,{kind:'shelf',surfaceId:'studio-shelf'}),
  ...
  make('site-youtube','room-media','YouTube','https://www.youtube.com/','tv','#c85c69',[4.6,.78,-6.05],true,0,{kind:'media',surfaceId:'lounge-tv'}),
  ...
  make('site-twitch','room-media','Twitch','https://www.twitch.tv/','poster','#9574ca',[-7.03,1.5,5.63],false,-Math.PI/4,{kind:'wall',surfaceId:'lounge-wall-left'}),
];

export const DEFAULT_PREFERENCES: Preferences = { lastRoomId:'room-home', trayOpen:false, trayPinned:false, reducedEffects:false, hasEntered:false, recentSearches:[], searchProvider:'duckduckgo', trayModules:['favorites','recent','note'], systemTrayEnabled:true, minimizeToTray:false, temperatureUnit:'fahrenheit', windowEffects:true,soundEnabled:false,soundVolume:.35,ambienceEnabled:true,onboardingMilestones:[] };
