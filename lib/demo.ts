...
export const DEMO_OBJECTS: BookmarkObject[] = [
  ...
  make('site-twitch','room-media','Twitch','https://www.twitch.tv/','poster','#9574ca',[7.03,1.5,5.63],false,-Math.PI*3/4,{kind:'wall',surfaceId:'lounge-wall-left'}),
];
