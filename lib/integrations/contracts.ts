...
export const browserMessageSchema=z.discriminatedUnion('type',[
  ...
  z.object({type:z.literal('send-page'),requestId:z.string(),page:browserTabSchema,roomId:z.string().optional(),collection:z.string().max(40).optional(),archetype:z.string().optional(),favorite:z.boolean().default(false)}),
