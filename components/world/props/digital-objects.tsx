...
function ScreenPanel({object,size=[1.42,.82],position=[0,1.35,.36],rotation=[0,0,0],selected,active,label}:ScreenProps){
  ...
  return <group position={position} rotation={rotation}>
    ...
    <BrandLogo identity={identity} size={Math.min(size[0],size[1])*.62} position={[0,.075,.055]}/>
...
function Terminal({object,selected,active}:ObjectProps){return <group>
  ...
  <Keyboard position={[0,.04,.24]} width={1.34}/>
...
function Book({object,active}:ObjectProps){const identity=siteIdentity(object),shelfMounted=object.mount?.kind==='shelf';return <group position={[0,shelfMounted?.44:.9,shelfMounted?.44:0]} scale={shelfMounted?.48:1}>
  ...
  <BrandLogo identity={identity} size={.48} position={[.06,.2,.27]}/>
...
function Pedestal({object,active}:ObjectProps){const identity=siteIdentity(object);return <group>
  ...
  <BrandLogo identity={identity} size={.3} position={[0,1.39,.54]}/>
  </group>}
...
function FileBox({object}:ObjectProps){const identity=siteIdentity(object);return <group>
  ...
  <BrandLogo identity={identity} size={.22} position={[0,.58,.58]}/>
...
function CompactPortal({object,active}:ObjectProps){const identity=siteIdentity(object);return <group position={[0,-.06,0]}>
  ...
  <BrandLogo identity={identity} size={.42} position={[0,1.21,.03]}/>
